...
function Header() {
  ...
  const isAdminPage =
    location.pathname === '/update-jd' ||
    location.pathname === '/admin-description' ||
    location.pathname === '/bulk-update';
    ...
    <header className="flex items-center justify-between p-4 bg-blue-600 text-white shadow-md">
      <div className="flex items-center">
        <button onClick={handleLogoClick} className="focus:outline-none">
          <img src={LTIMlogoBG} alt="Logo" className="h-12 w-34 ml-4 cursor-pointer" />
        </button>
      </div>
